...
function wechatShare(options) {
  ...
  var appId = wxOptions.appId || (window.bzConfig && window.bzConfig.wechatId) || 'wx06297e68f1f987bd'; // 默认使用「要个宝宝」的 APP ID
